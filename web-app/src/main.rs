...
#[get("/requestconfirm")]
fn requestconfirm() -> Template {
    Template::render(
        "requestconfirm",
        &TemplateContext {
            title: "requestconfirm",
            name: None,
            parent: "layout",
        },
    )
...
fn rocket() -> rocket::Rocket {
    rocket::ignite()
        .mount("/", routes![index, signin, signup, homelogin, paymentconfirm, requestconfirm])
